          ...
          <div>
            {role === "patient" && (
              ...
              >
                ...
                <span className="text-xs text-white relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-white dark:after:bg-green-400 after:transition-all after:duration-300">
                  Patient Mode
                </span>
              </div>
            )}
